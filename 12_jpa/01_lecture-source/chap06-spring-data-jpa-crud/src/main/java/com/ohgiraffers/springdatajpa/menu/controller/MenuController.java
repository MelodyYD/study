...
public class MenuController {
    ...
    @GetMapping("/{menuCode}")
    public String findMenuByPathVariable(@PathVariable(name = "menuCode") int menuCode, Model model) {
    ...
    @GetMapping("/list")
    public String findAllMenu(Model model, Pageable pageable) {
...
//        model.addAttribute("menus", menuList);
    ...
    @GetMapping("/search")
    public String findByMenuPrice(@RequestParam(name = "menuPrice") int menuPrice, Model model) {
    ...
    public List<CategoryDTO> findCategoryList() {
        // return 구문이 view 지정하는 것이 아닌, Data 를 return 한다.
