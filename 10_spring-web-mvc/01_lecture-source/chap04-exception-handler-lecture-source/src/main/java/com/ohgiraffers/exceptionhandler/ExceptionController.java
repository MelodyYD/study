...
public class ExceptionController {
    ...
    public String nullPointerException() {
        ...
        String str = null;
        // null 값에 참조를 하게 되면 NullPointerException 이 발생한다.
    ...
    /* 필기.
    *   @ExceptionHandler 어노테이션에 우리가 처리하고 싶은 예외 클래스를 정의하면
    *   정의한 클래스의 예외가 발생 시 nullHandler 메소드가 동작을 하게 된다.
    * */
    ...
    public String userExcepption(Model model, MemberNotFoundException exception) {
